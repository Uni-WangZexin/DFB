...
class DSANet(LightningModule):
    ...
    def forward(self, x, m=0):
        ...
        if m==0:
            ...
            re = torch.mean(attn1_horizon,dim = 1)
            return re
    ...
    def training_step(self, data_batch, batch_idx):
        ...
        y_hat2 = self.forward(x_2,1)

        # calculate loss
        loss_val = self.loss(y, y_hat1) + max(0, 2-self.loss(y, y_hat2))
